...
export default function Footer() {
  ...
  return (
    <footer className="bg-forest-green-dark text-white/80">
      {/* Main footer content */}
      <div className="mx-auto max-w-content px-6 py-20 lg:px-8">
        <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
          {/* Brand column */}
          <div className="lg:col-span-1">
            <Link href="/" className="inline-flex items-center gap-2 text-white no-underline hover:text-gold transition-colors duration-300">
            ...
            <p className="mt-4 text-sm leading-relaxed text-white/60 font-sans">
              Importation directe de mangues de qualité en provenance du Sénégal.
              Du verger sénégalais à votre table.
            </p>
          </div>

          {/* Navigation column */}
          <div>
            <h2 className="mb-6 text-xs font-semibold uppercase tracking-premium text-gold font-sans">
              Navigation
            </h2>
          ...
          <div>
            ...
            <ul className="space-y-3 font-sans">
              ...
              <li>
                <span className="text-sm text-white/70">SIREN : {companyInfo.siren}</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="mt-6 flex gap-4">
              <span className="flex h-10 w-10 items-center justify-center rounded-full border border-white/20 text-white/50 transition-all duration-300 hover:border-gold hover:text-gold" aria-label="Facebook">
              ...
              <span className="flex h-10 w-10 items-center justify-center rounded-full border border-white/20 text-white/50 transition-all duration-300 hover:border-gold hover:text-gold" aria-label="Instagram">
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto max-w-content px-6 py-6 lg:px-8">
